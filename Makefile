...
setup: ## Instala as dependencias do projeto.
	: ## --------------

	@pip install -r requirements.txt

clean: ## Remove pyc e __pycache__.
	: ## --------------
...
parse_folder: ## Obtém informações dos animes.
	: ## Os animes serão buscados a partir de uma pasta que estarão com as pastas dos animes.
	: ## As informações serão atualizadas.
	: ## --------------
